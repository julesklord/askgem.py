...
### 1. Architecture
Review [README.md](../README.md) for the 4-layer architecture overview:
...
### 2. Roadmap
Align new features with project priorities in [ROADMAP.md](../ROADMAP.md).
...
## Post-merge
Updates follow semantic versioning. Refer to [ROADMAP.md](../ROADMAP.md) for the release schedule.
