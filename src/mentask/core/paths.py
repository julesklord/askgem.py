...
- History: ~/.mentask/history/ (Chat session persistence)
...
def get_standard_knowledge_dir() -> Path:
    ...
    # This assumes the structure: src/mentask/core/paths.py
    # Standard Knowledge is in: src/mentask/agent/standard/
    return Path(__file__).parent.parent / "agent" / "standard"


def get_global_config_dir() -> Path:
    """Always returns the global ~/.mentask directory."""
    config_dir = Path.home() / ".mentask"
...
def get_config_dir() -> Path:
    ...
    Returns:
        Path: A Path object pointing to the active .mentask directory.
    """
...
def get_backups_dir() -> Path:
    ...
    Returns:
        Path: A Path object pointing to the ~/.mentask/backups directory.
    """
