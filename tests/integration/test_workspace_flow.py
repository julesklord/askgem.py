...
def mock_env(tmp_path):
    ...
    # Mock home to avoid touching real user files
    with patch("pathlib.Path.home", return_value=home_dir):
        # Initial state: CWD is project, but no .askgem exists
...
def test_memory_isolation(mock_env):
    ...
    from askgem.core.paths import get_local_knowledge_path, get_memory_path
